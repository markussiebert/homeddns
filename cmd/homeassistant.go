...
// LoadHomeAssistantConfig reads a Supervisor add-on options file (path configurable via ADDON_OPTIONS_PATH)
// and merges all keys into environment variables (uppercased, spaces -> underscores) before delegating to LoadConfig.
